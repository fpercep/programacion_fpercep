...
public class UsoDeObjetos {
	...
	public static void main(String[] args) throws ParseException {
        ...
        fechaNacimiento.set(2000, Calendar.NOVEMBER, 20);
		
		System.out.println("Utilidades Matematicas: ");
		System.out.println("Prueba función posicionDeDigito = " + UtilidadesMatematicas.posicionDeDigito(numero, 1));
		...
		System.out.println("Prueba función factorial = " + UtilidadesMatematicas.factorial(numero2));
